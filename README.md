...
Project Structure
AirflowTutorial/ │ airflow_steps.docx # Word file with step-by-step guide and screenshots │ ├───dags │ etl_dag.py # Example ETL DAG Python file │ └───screenshots dag_graph.png # DAG Graph View screenshot task_log.png # Task Instance logs screenshot
